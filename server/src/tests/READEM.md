...
Перевірити, чи є конфіги для баз даних у config/* для режиму test (якщо ні, то прописати як "test")

Створити PostgreSQL БД, виконавши скрипти:
...
Встановити змінну оточення NODE_ENV=test під час запуску npm test, змінивши скрипт:
